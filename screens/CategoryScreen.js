...
const CategoryScreen = ({ route, navigation }) => {
    ...
    return <View style={{flex: 1, backgroundColor: "#fff"}}>
        <View style={{backgroundColor: "#05c46b", height: 60, flexDirection: "row", alignItems: "center"}}>
        ...
        <View style={{flexDirection: "row", padding: 16, alignItems: "center", borderBottomColor: "#05c46b", borderBottomWidth: 3}}>
