...
const ReadSwitch = ({ isRead, check }) => {
    ...
    return <View style={{flexDirection: "row", alignItems: "center", justifyContent: "center"}}>
        ...
        <Pressable style={{width: 40, height: 24, borderRadius: 12, borderWidth: 2, borderColor: "#05c46b", marginHorizontal: 12, padding: 2}} onPress={() => check(!isRead)}>
            <Animated.View style={{width: 16, height: 16, borderRadius: 8, backgroundColor: "#05c46b", transform: [{ translateX }]}} />
        </Pressable>
