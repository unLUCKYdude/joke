    ...
    return <View style={{flex: 1}}>
        ...
        >
            <View style={{flex: 0.8, overflow: "hidden"}}>
                <View style={{backgroundColor: "#05c46b", height: 60, flexDirection: "row", alignItems: "center", paddingRight: 16, borderTopLeftRadius: 16, borderTopRightRadius: 16 }}>
        ...
        >
            <View style={{flex: 1, backgroundColor: "#fff"}}>
                <View style={{backgroundColor: "#05c46b", height: 60, flexDirection: "row", alignItems: "center", paddingRight: 16 }}>
